...
DEFINE_TEST(from_name,
	...
	.config = {
		[TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/new-from-name/",
	},
	.output = {
		.out = TESTSUITE_ROOTFS "test-libkmod/new-from-name/correct.txt",
	});
...
DEFINE_TEST(from_alias,
	...
	.config = {
		[TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/new-from-alias/",
	},
	.output = {
		.out = TESTSUITE_ROOTFS "test-libkmod/new-from-alias/correct.txt",
	});
...
DEFINE_TEST(
	...
	.config = {
		[TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/initstate/",
		[TC_UNAME_R] = "4.4.4",
	});
...
DEFINE_TEST(blacklist_1, .description = "check if modules are correctly blacklisted",
	    .config = {
		    [TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/blacklist/",
	    });
...
DEFINE_TEST(loaded_1,
	...
	.config = {
		[TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/loaded/",
	},
	.output = {
		.out = TESTSUITE_ROOTFS "test-libkmod/loaded/correct.txt",
	});
...
DEFINE_TEST(test_dependencies,
	    ...
	    .config = {
		    ...
		    [TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/dependencies/",
	    });
...
DEFINE_TEST(test_weakdep,
	...
	.config = {
		[TC_UNAME_R] = "4.4.4",
		[TC_ROOTFS] = TESTSUITE_ROOTFS "test-libkmod/weakdep",
		[TC_INIT_MODULE_RETCODES] = "",
	},
	.output = {
		.out = TESTSUITE_ROOTFS "test-libkmod/weakdep/correct.txt",
	});
